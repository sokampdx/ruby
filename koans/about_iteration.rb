...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # inject(initial value) { |cumulator, item| cumulator operator item }
    # cumulator = initial value and for each item cumulator operaotr= item.
  end
  ...
  # 
  # the scope of the open file is within the block do..end
