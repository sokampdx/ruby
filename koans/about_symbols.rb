...
class AboutSymbols < Neo::Koan
  ...
  # symbols are references. so to compare two of them, we need to compare the content which is a string. 
  ...
  # because symbol is immutable and stay in memory until program end. 
end
